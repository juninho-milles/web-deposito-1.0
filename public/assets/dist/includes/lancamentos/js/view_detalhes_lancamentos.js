...
$('#btnAcessarPdf').click(function() {
    var id = $('#idLancamento').val()

    $.ajax({
        url : '../../lancamentosAjax/buscarLink',
        type : 'POST',
...
function adicionarDocumento(){
    ...
    $.ajax({
		url  : '../../lancamentosAjax/cadastrarDocumento',
        type : 'POST',
        data : formData,
		processData: false,  
		contentType: false,
        ...
        success :  function(data){
            ...
            $('#cancel-pdf').attr('disabled', false)
            $('#btnAcessarPdf').css({"display":"block"})
            fecharModal()
        }
    });
}
