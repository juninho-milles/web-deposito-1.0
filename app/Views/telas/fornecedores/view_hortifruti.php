<div class="container">
    <div class="row">
        <div class="col-md-3">
            <h2><i class="fa fa-truck"></i> HORTIFRUTI</h2>
            <input type="hidden" id="tituloFornecedor" value="hortifruti">
        </div>
        ...
        <div class="col-md-6">
            <div class="input-group h2">
                ...
                <input type="hidden" name="inputBuscarFornecedorSetor" id="inputBuscarFornecedorSetor" value="hortifruti">
            </div>
        </div>
            ...
            <div class="modal-body">
	            ...
	            <div class="box-body">
                    ...
                    <div class="form-group" id="campoSetor">
                        <input type="hidden" id="inputSetor" name="inputSetor" value="hortifruti">
                    </div>
